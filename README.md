...
# them with ZENTINELLE_GATEWAY_TOKEN, set to the same value for the backend and
# the gateway (.env). Single-tenant alternative: ALLOW_ENV_PROVIDER_KEYS=true
# and PROVIDER_KEY_<NAME> on the gateway.
