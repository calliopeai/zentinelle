...
class ToolRouteAuthorityTests(TestCase):
    def test_required_approval_is_carried_into_pre_execution_policy_check(
            self):
        ...
        self.assertEqual(
            validate.call_args.args[3]['approval_token'],
            'approval-1')
