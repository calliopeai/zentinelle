...
class BudgetCharge(models.Model):
    ...
    team_id_ext = models.CharField(max_length=255, blank=True, default='', db_index=True)
    app_id_ext = models.CharField(max_length=255, blank=True, default='', db_index=True)
    session_id_ext = models.CharField(max_length=255, blank=True, default='', db_index=True)
    task_id_ext = models.CharField(max_length=255, blank=True, default='', db_index=True)
